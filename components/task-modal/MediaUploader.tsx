...
const ImageThumbnail = ({ src, onPreview, onRemove, isReadOnly }: { src: string, onPreview: (src: string) => void, onRemove: () => void, isReadOnly?: boolean }) => {
...
export const MediaUploader: React.FC<MediaUploaderProps> = ({ media = [], onChange, isReadOnly = false }) => {
